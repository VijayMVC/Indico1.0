                        ...
                        <GroupingSettings CaseSensitive="false" />
                            <MasterTableView  ShowGroupFooter="true" AllowMultiColumnSorting="false">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridDateTimeColumn AllowSorting="True"  FooterText="" FilterControlWidth="100px" DataField="OrderCutOffDate" HeaderText="Order Cut Off" UniqueName="OrderCutOffDate" SortExpression="OrderCutOffDate"  AllowFiltering="True" PickerType="DatePicker" Groupable="false"></telerik:GridDateTimeColumn>
                                    <telerik:GridDateTimeColumn AllowSorting="True"  FooterText="" FilterControlWidth="100px" DataField="EstimatedDateOfDespatch" HeaderText="Dispatch From Factory" UniqueName="EstimatedDateOfDespatch" SortExpression="EstimatedDateOfDespatch" PickerType="DatePicker" AllowFiltering="True" Groupable="false"></telerik:GridDateTimeColumn>
                                    <telerik:GridDateTimeColumn AllowSorting="True"  FooterText="" FilterControlWidth="100px" DataField="EstimatedDateOfArrival" HeaderText="Expected Arrival Date" UniqueName="EstimatedDateOfArrival" SortExpression="EstimatedDateOfArrival" PickerType="DatePicker" AllowFiltering="True" Groupable="false"></telerik:GridDateTimeColumn>
