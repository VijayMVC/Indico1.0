<%@ Page Title="" Language="C#" MasterPageFile="~/Indico.Master" AutoEventWireup="true"
    CodeBehind="ViewOrderStatus.aspx.cs" Inherits="Indico.ViewOrderStatus" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="iContentPlaceHolder" runat="server">
    ...
    <div class="page">
        ...
        <div class="page-header">
            <div class="header-actions">
                <a id="btnAddAgeGroup" runat="server" class="btn btn-link iadd pull-right">New Order Status</a>
            </div>
            <h3>
        ...
        <div class="page-content">
            <div class="row-fluid">
                ...
                <div id="dvEmptyContent" runat="server" class="alert alert-info">
                    <h2>
                        <a href="javascript:OrderStatusAddEdit(this, true, 'New Age Group');" title="Add an Age Group.">Add the first Order Status.</a>
                    </h2>
                    <p>
                        You can add as many Order Status as you like.
                    </p>
                </div>
                <!-- / -->
                <%--Data Content--%>
                <div id="dvDataContent" runat="server">
                    ...
                    <%-- <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" DefaultLoadingPanelID="RadAjaxLoadingPanel1">
                        <AjaxSettings>
                            <telerik:AjaxSetting AjaxControlID="RadGridOrderStatus">
                                <UpdatedControls>
                                    <telerik:AjaxUpdatedControl ControlID="RadGridOrderStatus"></telerik:AjaxUpdatedControl>
                                </UpdatedControls>
                            </telerik:AjaxSetting>
                        </AjaxSettings>
                    </telerik:RadAjaxManager>--%>
                    <telerik:RadGrid ID="RadGridOrderStatus" runat="server" AllowPaging="true" AllowFilteringByColumn="true" ShowGroupPanel="false" OnPageSizeChanged="RadGridOrderStatus_PageSizeChanged"
                        PageSize="20" OnPageIndexChanged="RadGridOrderStatus_PageIndexChanged" ShowFooter="false" EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true"
                        AutoGenerateColumns="false" OnItemDataBound="RadGridOrderStatus_ItemDataBound"
                        Skin="Metro" CssClass="RadGrid" AllowSorting="true" EnableEmbeddedSkins="true"
                        OnItemCommand="RadGridOrderStatus_ItemCommand"
                        OnSortCommand="RadGridOrderStatus_SortCommand">
                        ...
                        <MasterTableView AllowFilteringByColumn="true">
                            <Columns>
                                <telerik:GridBoundColumn UniqueName="Name" SortExpression="Name" HeaderText="Name" AllowSorting="true" CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" Groupable="false"
                                 ...
                                 <telerik:GridBoundColumn UniqueName="Sequence" SortExpression="Sequence" HeaderText="Sequence" AllowSorting="true" CurrentFilterFunction="Contains" Groupable="false"
                                    FilterControlWidth="150px" AutoPostBackOnFilter="true" DataField="Sequence">
                                </telerik:GridBoundColumn>
                                    ...
                                    <ItemTemplate>
                                        <div class="btn-group pull-right">
                                            ...
                                            <ul class="dropdown-menu pull-right">
                                                <li>
                                                    <asp:HyperLink ID="linkEdit" runat="server" CssClass="btn-link iedit" ToolTip="Edit Order Status"><i class="icon-pencil"></i>Edit</asp:HyperLink></li>
                                                <li>
                                                    <asp:HyperLink ID="linkDelete" runat="server" CssClass="btn-link idelete" ToolTip="Delete Order Status"><i class="icon-trash"></i>Delete</asp:HyperLink>
                                                </li>
                                            </ul>
                                        </div>
                                    </ItemTemplate>
    ...
    <!-- / -->
    <asp:HiddenField ID="hdnSelectedorderstatusId" runat="server" Value="0" />
    <!-- Add / Edit Item -->
            ...
            <fieldset>
                ...
                <div class="control-group">
                    <label class="control-label">
                        Sequence</label>
                    <div class="controls">
                        <asp:TextBox ID="txtOrder" runat="server" MaxLength="2"></asp:TextBox>
                    </div>
                </div>
            </fieldset>
        </div>
    ...
    <div id="requestDelete" class="modal fade" role="dialog" aria-hidden="true"
        ...
        <div class="modal-body">
            Are you sure you wish to delete this Ordser Status?
        </div>
        <div class="modal-footer">
            <button class="btn" data-dismiss="modal" aria-hidden="true">
                No</button>
    ...
    <script type="text/javascript">
        ...
        var orderstatusName = "<%=txtName.ClientID%>";
        var ordersequence = "<%=txtOrder.ClientID%>";
        var orderstatusDescription = "<%=txtDescription.ClientID%>";
        var btnSaveChanges = "<%=btnSaveChanges.ClientID%>";
        var hdnSelectedID = "<%=hdnSelectedorderstatusId.ClientID %>";
    </script>
    <script type="text/javascript">
        $(document).ready(function () {
            $('.iadd').click(function () {
                resetFieldsDefault('requestAddEdit');
                OrderStatusAddEdit(this, true);
            });

            $('.iedit').click(function () {
                fillText(this);
                OrderStatusAddEdit(this, false);
            });
            ...
            function OrderStatusAddEdit(o, n) {
                $('div.alert-danger, span.error').hide();
                $('#requestAddEdit div.modal-header h3 span')[0].innerHTML = (n ? 'Add Order Status' : 'Edit Order Status');
            ...
            function fillText(o) {
                $('#' + orderstatusName)[0].value = $(o).parents('tr').children('td')[0].innerHTML;
                $('#' + ordersequence)[0].value = (($(o).parents('tr').children('td')[1].innerHTML == '&nbsp;') ? '' : $(o).parents('tr').children('td')[1].innerHTML);
                $('#' + orderstatusDescription)[0].value = (($(o).parents('tr').children('td')[2].innerHTML == '&nbsp;') ? '' : $(o).parents('tr').children('td')[2].innerHTML);
            }
        });
    </script>
</asp:Content>
