<%@ Page Title="" Language="C#" MasterPageFile="~/Indico.Master" AutoEventWireup="true"
    CodeBehind="ViewOrderDetailStatus.aspx.cs" Inherits="Indico.ViewOrderDetailStatus" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="iContentPlaceHolder" runat="server">
    ...
    <div class="page">
        ...
        <div class="page-header">
            <div class="header-actions">
                <a id="btnAddAgeGroup" runat="server" class="btn btn-link iadd pull-right">New Order Detail Status</a>
            </div>
            <h3>
        ...
        <div class="page-content">
            <div class="row-fluid">
                ...
                <div id="dvEmptyContent" runat="server" class="alert alert-info">
                    <h2>
                        <a href="javascript:OrderDetailStatusAddEdit(this, true, 'New Age Group');" title="Add an Age Group.">Add the first Order Detail Status.</a>
                    </h2>
                    <p>
                        You can add as many Order Detail Status as you like.
                    </p>
                </div>
                <!-- / -->
                <%--Data Content--%>
                <div id="dvDataContent" runat="server">
                    ...
                    <%-- <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" DefaultLoadingPanelID="RadAjaxLoadingPanel1">
                        <AjaxSettings>
                            <telerik:AjaxSetting AjaxControlID="RadGridOrderDetailsStatus">
                                <UpdatedControls>
                                    <telerik:AjaxUpdatedControl ControlID="RadGridOrderDetailsStatus"></telerik:AjaxUpdatedControl>
                                </UpdatedControls>
                            </telerik:AjaxSetting>
                        </AjaxSettings>
                    </telerik:RadAjaxManager>--%>
                    <telerik:RadGrid ID="RadGridOrderDetailsStatus" runat="server" AllowPaging="true" AllowFilteringByColumn="true" ShowGroupPanel="false" OnPageSizeChanged="RadGridOrderDetailsStatus_PageSizeChanged"
                        PageSize="20" OnPageIndexChanged="RadGridOrderDetailsStatus_PageIndexChanged" ShowFooter="false" EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true"
                        AutoGenerateColumns="false" OnItemDataBound="RadGridOrderDetailsStatus_ItemDataBound"
                        Skin="Metro" CssClass="RadGrid" AllowSorting="true" EnableEmbeddedSkins="true"
                        OnItemCommand="RadGridOrderDetailsStatus_ItemCommand"
                        OnSortCommand="RadGridOrderDetailsStatus_SortCommand">
                                    ...
                                    <ItemTemplate>
                                        <div class="btn-group pull-right">
                                            ...
                                            <ul class="dropdown-menu pull-right">
                                                <li>
                                                    <asp:HyperLink ID="linkEdit" runat="server" CssClass="btn-link iedit" ToolTip="Edit Order Detail Status"><i class="icon-pencil"></i>Edit</asp:HyperLink></li>
                                                <li>
                                                    <asp:HyperLink ID="linkDelete" runat="server" CssClass="btn-link idelete" ToolTip="Delete Order Detail Status"><i class="icon-trash"></i>Delete</asp:HyperLink>
                                                </li>
                                            </ul>
                                        </div>
                                    </ItemTemplate>
    ...
    <div id="requestDelete" class="modal fade" role="dialog" aria-hidden="true"
        ...
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                ×</button>
            <h3>Delete Order Detail Status</h3>
        </div>
        <div class="modal-body">
            Are you sure you wish to delete this Order Detail Status?
        </div>
        <div class="modal-footer">
            <button class="btn" data-dismiss="modal" aria-hidden="true">
                No</button>
    ...
    <script type="text/javascript">
        ...
        var odsName = "<%=txtName.ClientID%>";
        var odsDescription = "<%=txtDescription.ClientID%>";
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('.iadd').click(function () {
                ...
                OrderDetailStatusAddEdit(this, true);
            });

            $('.iedit').click(function () {
                fillText(this);
                OrderDetailStatusAddEdit(this, false);
            });
            ...
            function OrderDetailStatusAddEdit(o, n) {
                $('div.alert-danger, span.error').hide();
                $('#requestAddEdit div.modal-header h3 span')[0].innerHTML = (n ? 'Add Order Detail Status' : 'Edit Order Detail Status');
            ...
            function fillText(o) {
                $('#' + odsName)[0].value = $(o).parents('tr').children('td')[0].innerHTML;
                $('#' + odsDescription)[0].value = (($(o).parents('tr').children('td')[1].innerHTML == '&nbsp;') ? '' : $(o).parents('tr').children('td')[1].innerHTML);
            }
        });
    </script>
</asp:Content>
