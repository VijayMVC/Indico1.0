            ...
            <div id="dvPageContent" runat="server" class="row-fluid">
                ...
                <div class="accordion-group">
                    ...
                    <div id="collapse4" runat="server" class="accordion-body collapse">
                        <div class="accordion-inner">                            
                            <asp:LinkButton class="btn-info" runat="server" ID="btnNewOrderDetail" OnClick="btnNewOrderDetail_Click" Text="New Order Detail" />    
                        ...
                        <fieldset>                                                                                                              
                            ...
                            <asp:UpdatePanel ID="UpdateVlNumber" runat="server" style="display: inline-block;">
                                <ContentTemplate>
                                    ...
                                    <div id="Div2" class="control-group" runat="server" visible="false">
                                        <label class="control-label">
                                            Repeat/New</label>
                                        <div class="controls">
