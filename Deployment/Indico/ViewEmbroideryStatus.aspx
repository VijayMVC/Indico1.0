<%@ Page Title="" Language="C#" MasterPageFile="~/Indico.Master" AutoEventWireup="true"
    CodeBehind="ViewEmbroideryStatus.aspx.cs" Inherits="Indico.ViewEmbroideryStatus" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="iContentPlaceHolder" runat="server">
    ...
    <div class="page">
        ...
        <div class="page-header">
            <div class="header-actions">
                <a id="btnAddAgeGroup" runat="server" class="btn btn-link iadd pull-right">New Embroidery
                    Status</a>
            </div>
            <h3>
        ...
        <div class="page-content">
            <div class="row-fluid">
                ...
                <div id="dvEmptyContent" runat="server" class="alert alert-info">
                    <h2>
                        <a href="javascript:EmbroideryStatusAddEdit(this, true, 'New Embroidery Status');"
                            title="Add an Embroidery Status.">Add the first Embroidery Status.</a>
                    </h2>
                    <p>
                        You can add as many Embroidery Status as you like.
                    </p>
                </div>
                <!-- / -->
                <%--Data Content--%>
                <div id="dvDataContent" runat="server">
                    ...
                    <%-- <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" DefaultLoadingPanelID="RadAjaxLoadingPanel1">
                        <AjaxSettings>
                            <telerik:AjaxSetting AjaxControlID="RadGridEmbroideriesStatus">
                                <UpdatedControls>
                                    <telerik:AjaxUpdatedControl ControlID="RadGridEmbroideriesStatus"></telerik:AjaxUpdatedControl>
                                </UpdatedControls>
                            </telerik:AjaxSetting>
                        </AjaxSettings>
                    </telerik:RadAjaxManager>--%>
                    <telerik:RadGrid ID="RadGridEmbroideriesStatus" runat="server" AllowPaging="true" AllowFilteringByColumn="true" ShowGroupPanel="false" OnPageSizeChanged="RadGridEmbroideriesStatus_PageSizeChanged"
                        PageSize="20" OnPageIndexChanged="RadGridEmbroideriesStatus_PageIndexChanged" ShowFooter="false" EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true"
                        AutoGenerateColumns="false" OnItemDataBound="RadGridEmbroideriesStatus_ItemDataBound"
                        Skin="Metro" CssClass="RadGrid" AllowSorting="true" EnableEmbeddedSkins="true"
                        OnItemCommand="RadGridEmbroideriesStatus_ItemCommand"
                        OnSortCommand="RadGridEmbroideriesStatus_SortCommand">
                        ...
                        <MasterTableView AllowFilteringByColumn="true">
                            <Columns>
                                <telerik:GridBoundColumn UniqueName="Name" SortExpression="Name" HeaderText="Name" AllowSorting="true" CurrentFilterFunction="Contains" AutoPostBackOnFilter="true"
                                    FilterControlWidth="150px" DataField="Name" Groupable="false">
                                    ...
                                    <ItemTemplate>
                                        <div class="btn-group pull-right">
                                            ...
                                            <ul class="dropdown-menu pull-right">
                                                <li>
                                                    <asp:HyperLink ID="linkEdit" runat="server" CssClass="btn-link iedit" ToolTip="Edit Embroidery Status"><i class="icon-pencil"></i>Edit</asp:HyperLink></li>
                                                <li>
                                                    <asp:HyperLink ID="linkDelete" runat="server" CssClass="btn-link idelete" ToolTip="Delete Embroidery Status"><i class="icon-trash"></i>Delete</asp:HyperLink>
                                                </li>
                                            </ul>
                                        </div>
                                    </ItemTemplate>
                    ...
                    <%--<asp:DataGrid ID="dgEmbroideryStatus" runat="server" CssClass="table" AllowCustomPaging="False"
                        AllowPaging="True" AllowSorting="true" AutoGenerateColumns="false" GridLines="None"
                        PageSize="20" OnItemDataBound="dgEmbroideryStatus_ItemDataBound" OnPageIndexChanged="dgEmbroideryStatus_PageIndexChanged"
                        OnSortCommand="dgEmbroideryStatus_SortCommand">
                                    ...
                                    <div class="btn-group pull-right">
                                        ...
                                        <ul class="dropdown-menu pull-right">
                                            <li>
                                                <asp:HyperLink ID="linkEdit" runat="server" CssClass="btn-link iedit" ToolTip="Edit Embroidery Status"><i class="icon-pencil"></i>Edit</asp:HyperLink></li>
                                            <li>
                                                <asp:HyperLink ID="linkDelete" runat="server" CssClass="btn-link idelete" ToolTip="Delete Embroidery Status"><i class="icon-trash"></i>Delete</asp:HyperLink></li>
                                        </ul>
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateColumn>
            ...
            <fieldset>
                <div class="control-group">
                    <label class="control-label required">
                        Name</label>
                    <div class="controls">
                        <asp:TextBox ID="txtStatusName" runat="server" MaxLength="128"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="rfvAgeGroupName" runat="server" CssClass="error"
                            ControlToValidate="txtStatusName" Display="Dynamic" EnableClientScript="False"
                         ...
                         <asp:CustomValidator ID="cvTxtName" runat="server" OnServerValidate="cvTxtName_ServerValidate" ErrorMessage="Name is already in use"
                            ControlToValidate="txtStatusName" EnableClientScript="false">
    ...
    <div id="requestDelete" class="modal fade" role="dialog" aria-hidden="true" keyboard="false"
        ...
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                ×</button>
            <h3>Delete Embroidery Status</h3>
        </div>
        <div class="modal-body">
            Are you sure you wish to delete this Embroidery Status?
        </div>
        <div class="modal-footer">
            <button class="btn" data-dismiss="modal" aria-hidden="true">
                No</button>
    ...
    <script type="text/javascript">
        ...
        var statusname = "<%=txtStatusName.ClientID%>";
        var estatusDescription = "<%=txtDescription.ClientID%>";
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('.iadd').click(function () {
                ...
                EmbroideryStatusAddEdit(this, true);
            });

            $('.iedit').click(function () {
                fillText(this);
                EmbroideryStatusAddEdit(this, false);
            });
            ...
            function EmbroideryStatusAddEdit(o, n) {
                $('div.alert-danger, span.error').hide();
                $('#requestAddEdit div.modal-header h3 span')[0].innerHTML = (n ? 'Add Embroidery Status' : 'Edit Embroidery Status');
            ...
            function fillText(o) {
                $('#' + statusname)[0].value = $(o).parents('tr').children('td')[0].innerHTML;
                $('#' + estatusDescription)[0].value = (($(o).parents('tr').children('td')[1].innerHTML == '&nbsp;') ? '' : $(o).parents('tr').children('td')[1].innerHTML);
            }
        });
    </script>
</asp:Content>
