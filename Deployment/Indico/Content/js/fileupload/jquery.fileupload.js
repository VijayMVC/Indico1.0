    ...
    FileUpload = function (container) {
        var fileUpload = this,
            ...
            settings = {
                ...
                dragDropSupport: function (input) {
                    switch (window.navigator.appName) {
                        ...
                        default:
                            {
                                if (input.attr('dragdrop') == null || input.attr('dragdrop') == '') {
                                    return 'true';
                                }
                                else {
                                    return input.attr('dragdrop');
                                }
                                break;
                            }
                    }
            ...
            initEventHandlers = function () {
                var dragdrop = getDragDropSupport(settings);
                if (dragdrop === 'true') {
            ...
            getDragDropSupport = function (settings) {
                if (typeof settings.dragDropSupport === func) {
                    return settings.dragDropSupport(settings.fileInput || fileInput);
                }
                return settings.dragDropSupport;
            },
