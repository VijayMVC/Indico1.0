<%@ Page Title="" Language="C#" MasterPageFile="~/Indico.Master" AutoEventWireup="true"
    CodeBehind="ViewPaymentTerms.aspx.cs" Inherits="Indico.ViewPaymentTerms" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="iContentPlaceHolder" runat="server">
    ...
    <div class="page">
        ...
        <div class="page-header">
            <div class="header-actions">
                <a id="btnAddPaymentTerm" runat="server" class="btn btn-link iadd pull-right">New Payment
                    Term</a>
            </div>
            <h3>
        ...
        <div class="page-content">
            <div class="row-fluid">
                ...
                <div id="dvEmptyContent" runat="server" class="alert alert-info">
                    <h4>
                        <a href="javascript:PaymentTermAddEdit(this, true, 'New Payment Terms');" title="Add an Payment Terms.">Add the first Payment Term.</a>
                    </h4>
                    <p>
                        You can add as many payment term as you like.
                    </p>
                </div>
                <!-- / -->
                <%--Data Content--%>
                <div id="dvDataContent" runat="server">
                    ...
                    <%-- <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" DefaultLoadingPanelID="RadAjaxLoadingPanel1">
                        <AjaxSettings>
                            <telerik:AjaxSetting AjaxControlID="RadGridPaymentTerms">
                                <UpdatedControls>
                                    <telerik:AjaxUpdatedControl ControlID="RadGridPaymentTerms"></telerik:AjaxUpdatedControl>
                                </UpdatedControls>
                            </telerik:AjaxSetting>
                        </AjaxSettings>
                    </telerik:RadAjaxManager>--%>
                    <telerik:RadGrid ID="RadGridPaymentTerms" runat="server" AllowPaging="true" AllowFilteringByColumn="true" ShowGroupPanel="false" OnPageSizeChanged="RadGridPaymentTerms_PageSizeChanged"
                        PageSize="20" OnPageIndexChanged="RadGridPaymentTerms_PageIndexChanged" ShowFooter="false" EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true"
                        AutoGenerateColumns="false" OnItemDataBound="RadGridPaymentTerms_ItemDataBound"
                        Skin="Metro" CssClass="RadGrid" AllowSorting="true" EnableEmbeddedSkins="true"
                        OnItemCommand="RadGridPaymentTerms_ItemCommand"
                        OnSortCommand="RadGridPaymentTerms_SortCommand">
                    ...
                    <%-- <asp:DataGrid ID="dataGridPaymentTerm" runat="server" CssClass="table" AllowCustomPaging="False"
                        AllowPaging="True" AllowSorting="true" AutoGenerateColumns="false" GridLines="None"
                        PageSize="20" OnItemDataBound="dataGridPaymentTerm_ItemDataBound" OnPageIndexChanged="dataGridPaymentTerm_PageIndexChanged"
                        OnSortCommand="dataGridPaymentTerm_SortCommand">
                            ...
                            <asp:TemplateColumn HeaderText="">
                                <ItemTemplate>
                                    <div class="btn-group pull-right">
                                        ...
                                        <ul class="dropdown-menu pull-right">
                                            <li>
                                                <asp:HyperLink ID="linkEdit" runat="server" CssClass="btn-link iedit" ToolTip="Edit Payment Term"><i class="icon-pencil"></i>Edit</asp:HyperLink></li>
                                            <li>
                                                <asp:HyperLink ID="linkDelete" runat="server" CssClass="btn-link idelete" ToolTip="Delete Payment Term"><i class="icon-trash"></i>Delete</asp:HyperLink></li>
                                        </ul>
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateColumn>
    ...
    <!-- / -->
    <asp:HiddenField ID="hdnSelectedPaymentTermID" runat="server" Value="0" />
    <!-- Add / Edit Item -->
            ...
            <fieldset>
                <div class="control-group">
                    <label class="control-label required">
                        Name</label>
                    <div class="controls">
                        <asp:TextBox ID="txtPaymentTermName" runat="server" MaxLength="128"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="rfvPaymentTerm" runat="server" CssClass="error" ControlToValidate="txtPaymentTermName"
                         ...
                         <asp:CustomValidator ID="cvTxtName" runat="server" OnServerValidate="cvTxtName_ServerValidate" ErrorMessage="Name is already in use"
                            ControlToValidate="txtPaymentTermName" EnableClientScript="false">
    ...
    <div id="requestDelete" class="modal fade" role="dialog" aria-hidden="true"
        ...
        <div class="modal-body">
            <p>
                Are you sure you wish to delete this Payment Term?
            </p>
        </div>
        <div class="modal-footer">
            <button class="btn" data-dismiss="modal" aria-hidden="true">
    ...
    <script type="text/javascript">
        ...
        var paymenttermName = "<%=txtPaymentTermName.ClientID%>";
        var paymenttermDescription = "<%=txtDescription.ClientID%>";
        var btnSaveChanges = "<%=btnSaveChanges.ClientID%>";
        var hdnSelectedID = "<%=hdnSelectedPaymentTermID.ClientID %>";
    </script>
    <script type="text/javascript">
        $(document).ready(function () {
            $('.iadd').click(function () {
                resetFieldsDefault('requestAddEdit');
                PaymentTermAddEdit(this, true);
            });

            $('.iedit').click(function () {
                fillText(this);
                PaymentTermAddEdit(this, false);
            });
            ...
            function PaymentTermAddEdit(o, n) {
                $('div.alert-danger, span.error').hide();
                $('#requestAddEdit div.modal-header h3 span')[0].innerHTML = (n ? 'Add Payment Term' : 'Edit Payment Term');
            ...
            function fillText(o) {
                $('#' + paymenttermName)[0].value = $(o).parents('tr').children('td')[0].innerHTML;
                $('#' + paymenttermDescription)[0].value = $(o).parents('tr').children('td')[1].innerHTML;
            }
        });
    </script>
</asp:Content>
