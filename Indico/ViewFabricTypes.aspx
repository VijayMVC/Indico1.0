<%@ Page Title="" Language="C#" MasterPageFile="~/Indico.Master" AutoEventWireup="true"
    CodeBehind="ViewFabricTypes.aspx.cs" Inherits="Indico.ViewFabricTypes" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="iContentPlaceHolder" runat="server">
    ...
    <div class="page">
        ...
        <div class="page-header">
            <div class="header-actions">
                <a id="btnAddAgeGroup" runat="server" class="btn btn-link iadd pull-right">New Fabric
                    Type</a>
            </div>
            <h3>
        ...
        <div class="page-content">
            <div class="row-fluid">
                ...
                <div id="dvEmptyContent" runat="server" class="alert alert-info">
                    <h2>
                        <a href="javascript:AgeGroupAddEdit(this, true, 'New Fabric Type');" title="Add New Fabric Type.">Add the first Fabric Type.</a>
                    </h2>
                    <p>
                        You can add as many Fabric Types as you like.
                    </p>
                </div>
                <!-- / -->
                <%--Data Content--%>
                <div id="dvDataContent" runat="server">
                    ...
                    <%-- <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" DefaultLoadingPanelID="RadAjaxLoadingPanel1">
                        <AjaxSettings>
                            <telerik:AjaxSetting AjaxControlID="RadGridFabricTypes">
                                <UpdatedControls>
                                    <telerik:AjaxUpdatedControl ControlID="RadGridFabricTypes"></telerik:AjaxUpdatedControl>
                                </UpdatedControls>
                            </telerik:AjaxSetting>
                        </AjaxSettings>
                    </telerik:RadAjaxManager>--%>
                    <telerik:RadGrid ID="RadGridFabricTypes" runat="server" AllowPaging="true" AllowFilteringByColumn="true" ShowGroupPanel="false" OnPageSizeChanged="RadGridFabricTypes_PageSizeChanged"
                        PageSize="20" OnPageIndexChanged="RadGridFabricTypes_PageIndexChanged" ShowFooter="false" EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true"
                        AutoGenerateColumns="false" OnItemDataBound="RadGridFabricTypes_ItemDataBound"
                        Skin="Metro" CssClass="RadGrid" AllowSorting="true" EnableEmbeddedSkins="true"
                        OnItemCommand="RadGridFabricTypes_ItemCommand"
                        OnSortCommand="RadGridFabricTypes_SortCommand">
                                    ...
                                    <ItemTemplate>
                                        <div class="btn-group pull-right">
                                            ...
                                            <ul class="dropdown-menu pull-right">
                                                <li>
                                                    <asp:HyperLink ID="linkEdit" runat="server" CssClass="btn-link iedit" ToolTip="Edit Fabric Type"><i class="icon-pencil"></i>Edit</asp:HyperLink></li>
                                                <li>
                                                    <asp:HyperLink ID="linkDelete" runat="server" CssClass="btn-link idelete" ToolTip="Delete Fabric Type"><i class="icon-trash"></i>Delete</asp:HyperLink>
                    ...
                    <%-- <asp:DataGrid ID="dgFabricTypes" runat="server" CssClass="table" AllowCustomPaging="False"
                        AllowPaging="True" AllowSorting="true" AutoGenerateColumns="false" GridLines="None"
                        PageSize="20" OnItemDataBound="dgFabricTypes_ItemDataBound" OnPageIndexChanged="dgFabricTypes_PageIndexChanged"
                        OnSortCommand="dgFabricTypes_SortCommand">
                                    ...
                                    <div class="btn-group pull-right">
                                        ...
                                        <ul class="dropdown-menu pull-right">
                                            <li>
                                                <asp:HyperLink ID="linkEdit" runat="server" CssClass="btn-link iedit" ToolTip="Edit Fabric Type"><i class="icon-pencil"></i>Edit</asp:HyperLink></li>
                                            <li>
                                                <asp:HyperLink ID="linkDelete" runat="server" CssClass="btn-link idelete" ToolTip="Delete Fabric Type"><i class="icon-trash"></i>Delete</asp:HyperLink></li>
                                        </ul>
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateColumn>
    ...
    <div id="requestDelete" class="modal fade" role="dialog" aria-hidden="true" keyboard="false"
        ...
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                ×</button>
            <h3>Delete Fabric Type</h3>
        </div>
        <div class="modal-body">
            Are you sure you wish to delete this Fabric Type?
        </div>
        <div class="modal-footer">
            <button class="btn" data-dismiss="modal" aria-hidden="true">
                No</button>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('.iadd').click(function () {
                ...
                FabricTypeAddEdit(this, true);
            });

            $('.iedit').click(function () {
                fillText(this);
                FabricTypeAddEdit(this, false);
            });
            ...
            function FabricTypeAddEdit(o, n) {
                $('div.alert-danger, span.error').hide();
                $('#requestAddEdit div.modal-header h3 span')[0].innerHTML = (n ? 'Add Fabric Type' : 'Edit Fabric Type');
