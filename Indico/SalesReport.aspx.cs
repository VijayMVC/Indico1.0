...
namespace Indico
{
    public partial class SalesReport : IndicoPage
    {
        #region Fields
        ...
        protected void btnViewReport_OnClick(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                ...
                this.rvSalesReport.LocalReport.ReportPath = Server.MapPath("~/Reports/Report1.rdl");
        ...
        {
            this.litHeaderText.Text = "Sales Report";
