<%@ Page EnableEventValidation="False" Language="C#" AutoEventWireup="true" CodeBehind="InventoryUoM.aspx.cs" MasterPageFile="~/Indico.Master" Inherits="Indico.InventoryUoM" %>
<asp:Content ID="Content1" ContentPlaceHolderID="iContentPlaceHolder" runat="server">
    ...
    <div class="page">
        <div class="page-header">
          ...
          <div class="page-content">
            ...
            <div class="row-fluid">
                <div class="wrapper">
                    <input id="txtSearch" name="txtSearch" runat="server" size="20" class="riTextBox riEnabled" type="text" value="" style="height: 25px;" />
                    ...
                    <div class="pull-right">
                        <input type="button" class="btn btn-primary" runat="server" value="New Unit Of Measure" id="btnAdd" style="height: 25px;" /><br />
                    </div>

                    <br />
                    <br />
                    <telerik:RadGrid ID="UoMGrid" runat="server" AllowPaging="true" AllowFilteringByColumn="true"
                        ShowGroupPanel="true" ShowFooter="false" OnPageSizeChanged="UoMGrid_PageSizeChanged"
                        PageSize="20" OnPageIndexChanged="UoMGrid_PageIndexChanged" EnableHeaderContextMenu="true"
                        EnableHeaderContextFilterMenu="true" AutoGenerateColumns="false" OnItemDataBound="UoMGrid_ItemDataBound"
                        Skin="Metro" CssClass="RadGrid" AllowSorting="true" EnableEmbeddedSkins="true" OnItemCommand="UoMGrid_ItemCommand" OnSortCommand="UoMGrid_SortCommand">
    ...
    <div id="requestDelete" class="modal fade" role="dialog" aria-hidden="true" keyboard="false"
        ...
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                ×</button>
            <h3>Delete Unit Of Measure
            </h3>
        </div>
        <div class="modal-body">
            <p>
                Are you sure you wish to delete Unit of Measure?
            </p>
        </div>
    ...
    <div id="requestAddEdit" class="modal fade" role="dialog" aria-hidden="true"
        ...
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                ×</button>
            <h3 id="lbladd">Add Unit of Measure</h3>
               <h3 id="lbledit">Edit Unit Of Measure</h3>
        </div>
        <div class="modal-body">
    ...
    <script type="text/javascript">
         ...
         (function ($) {
            ...
            var UoMName = "#<%=txtName.ClientID%>";
            var addButton = "#addButton";
            var saveButton = "#btnSaveChanges";
            var addNewUoMButton = "#<%=btnAdd.ClientID%>";
            ...
            function onSaveButtonClick() {
             ...
             $(function () {
                 ...
                 $(addNewUoMButton).on("click", onAddNewButtonClick);
