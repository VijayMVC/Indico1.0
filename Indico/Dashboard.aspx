<%@ Page Title="" Language="C#" MasterPageFile="~/Indico.Master" AutoEventWireup="true"
    CodeBehind="Dashboard.aspx.cs" Inherits="Indico.Dashboard" %>
        ...
        <div class="page-content">
            <div class="inner">
                ...
                <div id="dvClientOrderDetails" runat="server" visible="true" class="hero-unit">
                    ...
                    <p>
                        There are <asp:Literal ID="litOrderCount" runat="server"></asp:Literal> no submitted orders to be shown.</p>
                    <a id="ancOrderCount" class="btn btn-primary btn-large" runat="server">View Orders</a>
