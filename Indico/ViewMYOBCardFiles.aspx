<%@ Page Title="" Language="C#" MasterPageFile="~/Indico.Master" AutoEventWireup="true"
    CodeBehind="ViewMYOBCardFiles.aspx.cs" Inherits="Indico.ViewMYOBCardFiles" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="iContentPlaceHolder" runat="server">
    ...
    <div class="page">
        ...
        <div class="page-header">
            <div class="header-actions">
                <a id="btnAddMYOB" runat="server" class="btn btn-link iadd pull-right">New MYOB Card File</a>
            </div>
            <h3>
        ...
        <div class="page-content">
            <div class="row-fluid">
                ...
                <div id="dvEmptyContent" runat="server" class="alert alert-info">
                    <h2>
                        <a href="javascript:MYOBCardFileAddEdit(this, true, 'New MYOB Card File');" title="Add an MYOB Card File.">Add the first MYOB Card File.</a>
                    </h2>
                    <p>
                        You can add as many MYOB Card Files as you like.
                    </p>
                </div>
                <!-- / -->
                <%--Data Content--%>
                <div id="dvDataContent" runat="server">
                    ...
                    <telerik:RadGrid ID="RadGridMYOBCardFile" runat="server" AllowPaging="true" AllowFilteringByColumn="true" ShowGroupPanel="false" OnPageSizeChanged="RadGridMYOBCardFile_PageSizeChanged"
                        PageSize="20" OnPageIndexChanged="RadGridMYOBCardFile_PageIndexChanged" ShowFooter="false" EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true"
                        AutoGenerateColumns="false" OnItemDataBound="RadGridMYOBCardFile_ItemDataBound"
                        Skin="Metro" CssClass="RadGrid" AllowSorting="true" EnableEmbeddedSkins="true"
                        OnItemCommand="RadGridMYOBCardFile_ItemCommand"
                        OnSortCommand="RadGridMYOBCardFile_SortCommand">
    ...
    <!-- / -->
    <asp:HiddenField ID="hdnSelectedMYOBCardFileID" runat="server" Value="0" />
    <!-- Add / Edit Item -->
            ...
            <fieldset>
                <div class="control-group">
                    <label class="control-label required">
                        Name</label>
                    <div class="controls">
                        <asp:TextBox ID="txtMYOBCardFileName" runat="server" MaxLength="128"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="rfvMYOBCardFileName" runat="server" CssClass="error"
                            ControlToValidate="txtMYOBCardFileName" Display="Dynamic" EnableClientScript="False"
                         ...
                         <asp:CustomValidator ID="cvTxtName" runat="server" OnServerValidate="cvTxtName_ServerValidate" ErrorMessage="Name is already in use"
                            ControlToValidate="txtMYOBCardFileName" EnableClientScript="false">
    ...
    <div id="requestDelete" class="modal fade" role="dialog" aria-hidden="true"
        ...
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                ×</button>
            <h3>Delete MYOB Card File</h3>
        </div>
        <div class="modal-body">
            Are you sure you wish to delete this MYOB Card File?
        </div>
        <div class="modal-footer">
            <button class="btn" data-dismiss="modal" aria-hidden="true">
                No</button>
    ...
    <script type="text/javascript">
        ...
        var myobName = "<%=txtMYOBCardFileName.ClientID%>";
        var myobDescription = "<%=txtDescription.ClientID%>";
        var btnSaveChanges = "<%=btnSaveChanges.ClientID%>";
        var hdnSelectedID = "<%=hdnSelectedMYOBCardFileID.ClientID %>";
    </script>
    <script type="text/javascript">
        $(document).ready(function () {
            $('.iadd').click(function () {
                resetFieldsDefault('requestAddEdit');
                MYOBCardFileAddEdit(this, true);
            });

            $('.iedit').click(function () {
                fillText(this);
                MYOBCardFileAddEdit(this, false);
            });
            ...
            function MYOBCardFileAddEdit(o, n) {
                $('div.alert-danger, span.error').hide();
                $('#requestAddEdit div.modal-header h3 span')[0].innerHTML = (n ? 'Add MYOB Card File' : 'Edit MYOB Card File');
            ...
            function fillText(o) {
                $('#' + myobName)[0].value = $(o).parents('tr').children('td')[0].innerHTML;
                $('#' + myobDescription)[0].value = (($(o).parents('tr').children('td')[1].innerHTML == '&nbsp;') ? '' : $(o).parents('tr').children('td')[1].innerHTML);
            }
        });
    </script>
</asp:Content>
