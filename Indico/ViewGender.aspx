<%@ Page Title="" Language="C#" MasterPageFile="~/Indico.Master" AutoEventWireup="true"
    CodeBehind="ViewGender.aspx.cs" Inherits="Indico.ViewGender" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="iContentPlaceHolder" runat="server">
        ...
        <div class="page-content">
            <div class="row-fluid">
                ...
                <div id="dvEmptyContent" runat="server" class="alert alert-info">
                    <h4>
                        <a href="javascript:GenderAddEdit(this, true, 'New Gender');" title="Add an Gender.">Add the first Gender.</a>
                    </h4>
                    <p>
                        You can add as many Gender as you like.
                    </p>
                </div>
                <!-- / -->
                <!-- Data Content -->
                <div id="dvDataContent" runat="server">
                    ...
                    <%-- <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" DefaultLoadingPanelID="RadAjaxLoadingPanel1">
                        <AjaxSettings>
                            <telerik:AjaxSetting AjaxControlID="RadGridGender">
                                <UpdatedControls>
                                    <telerik:AjaxUpdatedControl ControlID="RadGridGender"></telerik:AjaxUpdatedControl>
                                </UpdatedControls>
                            </telerik:AjaxSetting>
                        </AjaxSettings>
                    </telerik:RadAjaxManager>--%>
                    <telerik:RadGrid ID="RadGridGender" runat="server" AllowPaging="true" AllowFilteringByColumn="true" ShowGroupPanel="false" OnPageSizeChanged="RadGridGender_PageSizeChanged"
                        PageSize="20" OnPageIndexChanged="RadGridGender_PageIndexChanged" ShowFooter="false" EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true"
                        AutoGenerateColumns="false" OnItemDataBound="RadGridGender_ItemDataBound"
                        Skin="Metro" CssClass="RadGrid" AllowSorting="true" EnableEmbeddedSkins="true"
                        OnItemCommand="RadGridGender_ItemCommand"
                        OnSortCommand="RadGridGender_SortCommand">
                                    ...
                                    <ItemTemplate>
                                        <div class="btn-group pull-right">
                                            ...
                                            <ul class="dropdown-menu pull-right">
                                                <li>
                                                    <asp:HyperLink ID="linkEdit" runat="server" CssClass="btn-link iedit" ToolTip="Edit Gender"><i class="icon-pencil"></i>Edit</asp:HyperLink></li>
                                                <li>
                                                    <asp:HyperLink ID="linkDelete" runat="server" CssClass="btn-link idelete" ToolTip="Delete Gender"><i class="icon-trash"></i>Delete</asp:HyperLink></li>
                                            </ul>
                                        </div>
                                    </ItemTemplate>
                    ...
                    <%-- <asp:DataGrid ID="dataGridGender" runat="server" CssClass="table" AllowCustomPaging="False"
                        AllowPaging="True" AllowSorting="true" AutoGenerateColumns="false" GridLines="None"
                        PageSize="20" OnItemDataBound="dataGridGender_ItemDataBound" OnPageIndexChanged="dataGridGender_PageIndexChanged"
                        OnSortCommand="dataGridGender_SortCommand">
    ...
    <!-- / -->
    <asp:HiddenField ID="hdnSelectedGenderID" runat="server" Value="0" />
    <!-- Add / Edit Item -->
            ...
            <fieldset>
                <div class="control-group">
                    <label class="control-label required">
                        Name</label>
                    <div class="controls">
                        <asp:TextBox ID="txtGenderName" runat="server" MaxLength="128"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="rfvGenderName" runat="server" CssClass="error" ControlToValidate="txtGenderName"
                         ...
                         <asp:CustomValidator ID="cvTxtName" runat="server" OnServerValidate="cvTxtName_ServerValidate" ErrorMessage="Name is already in use"
                            ControlToValidate="txtGenderName" EnableClientScript="false">
    ...
    <div id="requestDelete" class="modal fade" role="dialog" aria-hidden="true"
        ...
        <div class="modal-body">
            <p>
                Are you sure you wish to delete this Gender?
            </p>
        </div>
        <div class="modal-footer">
            <button class="btn" data-dismiss="modal" aria-hidden="true">
    ...
    <script type="text/javascript">
        ...
        var genderName = "<%=txtGenderName.ClientID%>";
        var btnSaveChanges = "<%=btnSaveChanges.ClientID%>";
        var hdnSelectedID = "<%=hdnSelectedGenderID.ClientID %>";
    </script>
    <script type="text/javascript">
        $(document).ready(function () {
            $('.iadd').click(function () {
                resetFieldsDefault('requestAddEdit');
                GenderAddEdit(this, true);
            });

            $('.iedit').click(function () {
                fillText(this);
                GenderAddEdit(this, false);
            });
            ...
            function GenderAddEdit(o, n) {
                $('div.alert-danger, span.error').hide();
                $('#requestAddEdit div.modal-header h3 span')[0].innerHTML = (n ? 'Add Gender' : 'Edit Gender');
            ...
            function fillText(o) {
                $('#' + genderName)[0].value = $(o).parents('tr').children('td')[0].innerHTML;
            }
        });
    </script>
</asp:Content>
