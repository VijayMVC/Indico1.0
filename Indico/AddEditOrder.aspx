                        ...
                        <div class="accordion-inner">
                            ...
                            <asp:DataGrid ID="dgOrderItems" runat="server" CssClass="table" AllowCustomPaging="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateColumn HeaderText="Repeat">
                                        <ItemTemplate>
                                            <asp:Literal ID="lblRepeat" runat="server" Text=""></asp:Literal>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                    <asp:TemplateColumn HeaderText="VL Number/ Pattern/ Fabric">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="hlVlNumber" runat="server" Target="_blank"></asp:HyperLink>
                                    ...
                                    <asp:TemplateColumn HeaderText="EMB">
                                        <ItemTemplate>
                                            <asp:Literal ID="litEmbroidery" runat="server"></asp:Literal>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                    <asp:TemplateColumn HeaderText="Color Profile">
                                        <ItemTemplate>
                                            <asp:Literal ID="litColorProfile" runat="server"></asp:Literal>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                                ...
                                                <div class="thumbnail">
                                                    ...
                                                    <div class="caption">
                                                        <h3 class="text-center">
                                                            <asp:Literal ID="litVLImageCaption" runat="server" Text="Visual Layout Image" />
                                                        </h3>
                                                    </div>
                                                </div>
                                            </li>
