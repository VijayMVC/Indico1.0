                        ...
                        <div class="accordion-inner">
                            ...
                            <div id="liDistributor" runat="server" class="control-group">
                                <label class="control-label required">
                                    Distributor</label>
                                <div class="controls">
                                    <asp:DropDownList CssClass="input-xxlarge" ID="ddlDistributor" runat="server"  OnSelectedIndexChanged="ddlDistributor_SelectedIndexChanged" AutoPostBack="true">
                                    </asp:DropDownList>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <telerik:RadComboBox ID="RadComboReservations" runat="server" HighlightTemplatedItems="true"
                                        Skin="Metro" CssClass="RadComboBox_Metro" AutoPostBack="true" DropDownWidth="650"
                                        OnItemDataBound="RadComboReservations_ItemDataBound" DataTextField="ID"
                                        EmptyMessage="Select Reservation" EnableLoadOnDemand="true" Filter="StartsWith" DataValueField="ID" CheckBoxes="true">
                                        <HeaderTemplate>
                                            <table style="width: 100%" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td style="width: 15%;">Reservation No
                                                    </td>
                                                    <td style="width: 15%;">Order Week
                                                    </td>
                                                    <td style="width: 15%;">ETD
                                                    </td>
