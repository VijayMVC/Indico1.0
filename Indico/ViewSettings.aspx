<%@ Page Title="" Language="C#" MasterPageFile="~/Indico.Master" AutoEventWireup="true"
    CodeBehind="ViewSettings.aspx.cs" Inherits="Indico.ViewSettings" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="iContentPlaceHolder" runat="server">
    ...
    <div class="page">
        ...
        <div class="page-header">
            <div class="header-actions">
                <a id="btnAddSetting" runat="server" class="btn btn-link iadd pull-right">New Setting</a>
            </div>
            <h3>
        ...
        <div class="page-content">
            <div class="row-fluid">
                ...
                <div id="dvEmptyContent" runat="server" class="alert alert-info">
                    ...
                    <p>
                        You can add as many Settings as you like.
                    </p>
                </div>
                <!-- / -->
                <%--Data Content--%>
                <div id="dvDataContent" runat="server">
                    ...
                    <telerik:RadGrid ID="RadGridSettings" runat="server" AllowPaging="true" AllowFilteringByColumn="true" ShowGroupPanel="false" OnPageSizeChanged="RadGridSettings_PageSizeChanged"
                        PageSize="20" OnPageIndexChanged="RadGridSettings_PageIndexChanged" ShowFooter="false" EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true"
                        AutoGenerateColumns="false" OnItemDataBound="RadGridSettings_ItemDataBound"
                        Skin="Metro" CssClass="RadGrid" AllowSorting="true" EnableEmbeddedSkins="true"
                        OnItemCommand="RadGridSettings_ItemCommand"
                        OnSortCommand="RadGridSettings_SortCommand">
                        ...
                        <MasterTableView AllowFilteringByColumn="true">
                            <Columns>
                                ...
                                <telerik:GridBoundColumn UniqueName="Value" SortExpression="Value" HeaderText="Value" AllowSorting="true" CurrentFilterFunction="Contains" Groupable="false"
                                    FilterControlWidth="150px" AutoPostBackOnFilter="true" DataField="Value">
                                </telerik:GridBoundColumn>
                                    ...
                                    <ItemTemplate>
                                        <div class="btn-group pull-right">
                                            ...
                                            <ul class="dropdown-menu pull-right">
                                                <li>
                                                    <asp:HyperLink ID="linkEdit" runat="server" CssClass="btn-link iedit" ToolTip="Edit Setting"><i class="icon-pencil"></i>Edit</asp:HyperLink></li>
                                                <li>
                                                    <asp:HyperLink ID="linkDelete" runat="server" CssClass="btn-link idelete" ToolTip="Delete Setting"><i class="icon-trash"></i>Delete</asp:HyperLink>
                                                </li>
                                            </ul>
                                        </div>
                                    </ItemTemplate>
    ...
    <!-- / -->
    <asp:HiddenField ID="hdnSelectedSettingID" runat="server" Value="0" />
    <!-- Add / Edit Item -->
            ...
            <fieldset>
                <div class="control-group">
                    <label class="control-label required">
                        Name</label>
                    <div class="controls">
                        <asp:TextBox ID="txtSettingName" runat="server" MaxLength="128"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="rfvSettingName" runat="server" CssClass="error"
                            ControlToValidate="txtSettingName" Display="Dynamic" EnableClientScript="False"
                         ...
                         <asp:CustomValidator ID="cvTxtName" runat="server" OnServerValidate="cvTxtName_ServerValidate" ErrorMessage="Name is already in use"
                            ControlToValidate="txtSettingName" EnableClientScript="false">
                ...
                <div class="control-group">
                    <label class="control-label">
                        Value</label>
                    <div class="controls">
                        <asp:TextBox ID="txtValue" runat="server" CssClass="topic_d" MaxLength="128"
    ...
    <script type="text/javascript">
        ...
        var settingName = "<%=txtSettingName.ClientID%>";
        var settingValue = "<%=txtValue.ClientID%>";
        var btnSaveChanges = "<%=btnSaveChanges.ClientID%>";
        var hdnSelectedID = "<%=hdnSelectedSettingID.ClientID %>";
    </script>
    <script type="text/javascript">
        $(document).ready(function () {
            $('.iadd').click(function () {
                resetFieldsDefault('requestAddEdit');
                SettingAddEdit(this, true);
            });

            $('.iedit').click(function () {
                fillText(this);
                SettingAddEdit(this, false);
            });
            ...
            function SettingAddEdit(o, n) {
                $('div.alert-danger, span.error').hide();
                $('#requestAddEdit div.modal-header h3 span')[0].innerHTML = (n ? 'Add Setting' : 'Edit Setting');
            ...
            function fillText(o) {
                $('#' + settingName)[0].value = $(o).parents('tr').children('td')[0].innerHTML;
                $('#' + settingValue)[0].value = (($(o).parents('tr').children('td')[1].innerHTML == '&nbsp;') ? '' : $(o).parents('tr').children('td')[1].innerHTML);
            }
        });
    </script>
</asp:Content>
