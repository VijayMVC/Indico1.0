<%@ Page EnableEventValidation="False" Language="C#" AutoEventWireup="true" CodeBehind="Receipts.aspx.cs" MasterPageFile="~/Indico.Master" Inherits="Indico.Receipts" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="iContentPlaceHolder" runat="server">
            ...
            <div class="row-fluid">
                <div class="wrapper">
                    ...
                    <div class="pull-right">
                        <input type="button" class="btn btn-primary" runat="server" value="New Receipt" id="btnAdd" style="height: 25px;"/><br />
                    </div>
                    <br />
                    <br />
                    <telerik:RadGrid ID="ReceiptsGrid" runat="server" AllowPaging="true" AllowFilteringByColumn="true" 
                        ShowGroupPanel="true" ShowFooter="false" OnPageSizeChanged="ReceiptsGrid_PageSizeChanged" OnItemCommand="ReceiptsGrid_ItemCommand"
                        PageSize="20" OnPageIndexChanged="ReceiptsGrid_PageIndexChanged" EnableHeaderContextMenu="true"
                        EnableHeaderContextFilterMenu="true" AutoGenerateColumns="false" OnItemDataBound="ReceiptsGrid_ItemDataBound" OnSortCommand="ReceiptsGrid_SortCommand"
    ...
    <div id="requestDelete" class="modal fade" role="dialog" aria-hidden="true" keyboard="false"
        ...
        <div class="modal-body">
            <p>
                Are you sure you wish to delete this Receipt?
            </p>
        </div>
    ...
    <div id="requestAddEdit" class="modal fade" role="dialog" aria-hidden="true"
        ...
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
               ...
               <h3 id="lbledit">Edit Receipt</h3>
            <h3 id="lbladd">Add Receipt</h3>
        </div>
        <div class="modal-body">
...
<%--                                    <asp:RequiredFieldValidator ID="rfvStrikeDate" runat="server" ErrorMessage="Strike Date is required"
                ...
                <div class="control-group">
                    <label class="control-label required">
                        Item</label>
                    <div class="controls">
                        <asp:DropDownList ID="ddlItem" runat="server" AutoPostBack="true" DataValueField="ID" DataTextField="Name" CssClass="topic_d"  MaxLength="255"></asp:DropDownList>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            function isFormValid() {
                ...
                error += validateControl("#<%=TransactionNo.ClientID%>", "Transaction No");
