<%@ Page EnableEventValidation="False" Language="C#" AutoEventWireup="true" CodeBehind="Vendor.aspx.cs" MasterPageFile="~/Indico.Master" Inherits="Indico.Vendor" %>
<asp:Content ID="Content1" ContentPlaceHolderID="iContentPlaceHolder" runat="server">
            ...
            <div class="row-fluid">
                <div class="wrapper">
                    ...
                    <div class="pull-right">
                        <input type="button" class="btn btn-primary" runat="server" value="New Vendor" id="btnAdd" style="height: 25px;" />
                    </div>
                    <br />
                    <br />
                     <telerik:RadGrid ID="VendorGrid" runat="server" AllowPaging="true" AllowFilteringByColumn="true"
                        ShowGroupPanel="true" ShowFooter="false" OnPageSizeChanged="VendorGrid_PageSizeChanged"
                        PageSize="20" OnPageIndexChanged="VendorGrid_PageIndexChanged" EnableHeaderContextMenu="true"
                        EnableHeaderContextFilterMenu="true" AutoGenerateColumns="false" OnItemDataBound="VendorGrid_ItemDataBound"
                        Skin="Metro" CssClass="RadGrid" AllowSorting="true" EnableEmbeddedSkins="true" OnItemCommand="VendorGrid_ItemCommand" OnSortCommand="VendorGrid_SortCommand">
    ...
    <div id="requestAddEdit" class="modal fade" role="dialog" aria-hidden="true"
        ...
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                ×</button>
            <h3 id="lbladd">Add Vendor</h3>
            <h3 id="lbledit">Edit Vendor</h3>
        </div>
        <div class="modal-body">
    ...
    <!--Modals-->
      <script type="text/javascript">
        ...
        (function ($) {
            ...
            var VendorName = "#<%=txtName.ClientID%>";
            var addButton = "#addButton";
            var saveButton = "#btnSaveChanges";
            var addNewVendorButton = "#<%=btnAdd.ClientID%>";
            ...
            $(function () {
                ...
                $(addNewVendorButton).on("click", onAddNewButtonClick);
