<%@ Page Title="" Language="C#" MasterPageFile="~/Indico.Master" AutoEventWireup="true"
    CodeBehind="DetailReport.aspx.cs" Inherits="Indico.DetailReport" %>
                ...
                <div class="search-control clearfix">
                    <div id="dvAdminFilters" runat="server" class="form-inline pull-left well well-sm">
                        <div class="pull-left" style="text">
                            ...
                            <asp:RequiredFieldValidator ID="rfvDdlDistributor" runat="server" ErrorMessage="Distributor is required"
                                ValidationGroup="validateDate" ControlToValidate="ddlDistributor" EnableClientScript="true" InitialValue="0">
