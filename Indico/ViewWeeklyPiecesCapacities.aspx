<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewWeeklyPiecesCapacities.aspx.cs" Inherits="Indico.ViewWeeklyPiecesCapacities"   MasterPageFile="~/Indico.Master" %>
         ...
         <div class="page-content">
            <div class="row-fluid">
                 <div id="dvEmptyContent" runat="server" class="alert alert-info">
                    <h4>
                        <a title="Weekly Pieces Capacities.">Weekly Pieces Capacities.</a>
                    </h4>
                    <p>
                        There are no data for  Weekly Pieces capacities
                    </p>
                </div> <!-- Empty COntent-->
                ...
                <div id="dvDataContent" runat="server">
                   ...
                   <telerik:RadGrid runat="server" ID="WeeklyPiecesSummaryRedGrid" AllowPaging="True" AllowFilteringByColumn="true" ShowGroupPanel="false" 
                                    ...
                                    OnItemCommand="OnWeeklyPiecesSummaryRedGridItemCommand"
                                    OnItemDataBound="OnWeeklyPiecesSummaryRedGridItemDataBound"
                                    OnPageIndexChanged="OnWeeklyPiecesSummaryRedGridPageIndexChanged"
                                    OnPageSizeChanged="OnWeeklyPiecesSummaryRedGridPageSizeChanged"
                                    OnSortCommand="OnWeeklyPiecesSummaryRedGridSortCommand">
                       ...
                       <MasterTableView AllowFilteringByColumn="true">
                          ...
                          <ColumnGroups>
                                ...
                                <telerik:GridColumnGroup HeaderText="Upto 5 Orders" Name="PolosUptoFiveOrders" HeaderStyle-HorizontalAlign="Center" ParentGroupName="Polos">
                                </telerik:GridColumnGroup>
                                <telerik:GridColumnGroup HeaderText="Upto 5 Orders" Name="OuterwareUptoFiveOrders" HeaderStyle-HorizontalAlign="Center" ParentGroupName="Jackets">
                                </telerik:GridColumnGroup>
                                <telerik:GridColumnGroup HeaderText="Samples" Name="PolosSamples" HeaderStyle-HorizontalAlign="Center" ParentGroupName="Polos">
                                </telerik:GridColumnGroup>
                                <telerik:GridColumnGroup HeaderText="Samples" Name="OuterwareSamples" HeaderStyle-HorizontalAlign="Center" ParentGroupName="Jackets">
                                </telerik:GridColumnGroup>
                            </ColumnGroups>
                           <Columns>
                            <telerik:GridTemplateColumn HeaderText="Year/Week #" AllowFiltering="false" UniqueName="YearWeekNumber">
                                <ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn HeaderText="<=5" AllowFiltering="false" ColumnGroupName="PolosUptoFiveOrders"   Aggregate="Sum" DataField="PoloUptoFiveItems" FooterAggregateFormatString="{0:N0}" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                                <ItemTemplate>
                                    <asp:HyperLink ID="PoloLessFiveItemsLink" runat="server"></asp:HyperLink>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridBoundColumn HeaderText="Capacity" AllowFiltering="false" ColumnGroupName="PolosUptoFiveOrders"   Aggregate="Sum" DataField="PoloFivePcsCapacity"  FooterAggregateFormatString="{0:N0}" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Samples" AllowFiltering="false" ColumnGroupName="PolosSamples"  Aggregate="Sum" DataField="PoloSamples"  FooterAggregateFormatString="{0:N0}" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                                <ItemTemplate>
                                    <asp:HyperLink ID="PoloSampleItemsLink" runat="server"></asp:HyperLink>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridBoundColumn HeaderText="Capacity" AllowFiltering="false" ColumnGroupName="PolosSamples"  Aggregate="Sum" DataField="PoloSampleCapacity"  FooterAggregateFormatString="{0:N0}" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridTemplateColumn HeaderText="<=5" AllowFiltering="false" ColumnGroupName="OuterwareUptoFiveOrders" Aggregate="Sum" DataField="OuterwareUptoFiveItems"  FooterAggregateFormatString="{0:N0}" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                                <ItemTemplate>
                                    <asp:HyperLink ID="OuterwareLessFiveItemsLink" runat="server"></asp:HyperLink>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridBoundColumn HeaderText="Capacity" AllowFiltering="false" ColumnGroupName="OuterwareUptoFiveOrders"  Aggregate="Sum" DataField="OuterwareFivePcsCapacity"  FooterAggregateFormatString="{0:N0}" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                            </telerik:GridBoundColumn>
                            <telerik:GridTemplateColumn HeaderText="Samples" AllowFiltering="false" ColumnGroupName="OuterwareSamples"  Aggregate="Sum" DataField="OuterwareSamples"  FooterAggregateFormatString="{0:N0}" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                                <ItemTemplate>
                                    <asp:HyperLink ID="OuterwareSampleItemsLink" runat="server"></asp:HyperLink>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridBoundColumn HeaderText="Capacity" AllowFiltering="false" ColumnGroupName="OuterwareSamples"  Aggregate="Sum" DataField="OuterwareSampleCapacity"  FooterAggregateFormatString="{0:N0}" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                            </telerik:GridBoundColumn>
