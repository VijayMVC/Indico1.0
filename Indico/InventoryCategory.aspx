<%@ Page EnableEventValidation="False" Language="C#" AutoEventWireup="true" CodeBehind="InventoryCategory.aspx.cs" MasterPageFile="~/Indico.Master" Inherits="Indico.InventoryCategory" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="iContentPlaceHolder" runat="server">
            ...
            <div class="row-fluid">
                <div class="wrapper">
                    ...
                    <div class="pull-right">
                        <input type="button" class="btn btn-primary" runat="server" value="New Category" id="btnAdd" style="height: 25px;" /><br />
                    </div>
                    <br />
                    <br />
                    
                    <telerik:RadGrid ID="CategoryGrid" runat="server" AllowPaging="true" AllowFilteringByColumn="true"
                        ShowGroupPanel="true" ShowFooter="false" OnPageSizeChanged="CategoryGrid_PageSizeChanged"
                        PageSize="20" OnPageIndexChanged="CategoryGrid_PageIndexChanged" EnableHeaderContextMenu="true"
                        EnableHeaderContextFilterMenu="true" AutoGenerateColumns="false" OnItemDataBound="CategoryGrid_ItemDataBound"
                        Skin="Metro" CssClass="RadGrid" AllowSorting="true" EnableEmbeddedSkins="true" OnItemCommand="CategoryGrid_ItemCommand" OnSortCommand="CategoryGrid_SortCommand">
    ...
    <div id="requestAddEdit" class="modal fade" role="dialog" aria-hidden="true"
        ...
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                ×</button>
            <h3 id="lbladd">Add Category</h3>
            <h3 id="lbledit">Edit Category</h3>
        </div>
        <div class="modal-body">
    ...
    <script type="text/javascript">
        ...
        (function ($) {
            ...
            var addNewCategoryButton = "#<%=btnAdd.ClientID%>";
            ...
            function getDataFromPage(method, data, success, error) {
                $.ajax({
                    type: "POST",
                    url: "InventoryCategory.aspx/" + method,
            ...
            $(function () {
                ...
                $(addNewCategoryButton).on("click", onAddNewButtonClick);
