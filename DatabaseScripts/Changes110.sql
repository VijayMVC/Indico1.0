...
/****** Object:  StoredProcedure [dbo].[SPC_GetWeeklySummary]    Script Date: 09/30/2014 11:54:50 ******/
...
/****** Object:  View [dbo].[ReturnWeeklySummaryView]    Script Date: 09/30/2014 12:03:12 ******/
...
--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**
/****** Object:  StoredProcedure [dbo].[SPC_GetWeeklyFirmOrders]    Script Date: 09/30/2014 15:03:26 ******/
...
/****** Object:  StoredProcedure [dbo].[SPC_ViewOrderDetails]    Script Date: 09/30/2014 15:17:13 ******/
...
/****** Object:  StoredProcedure [dbo].[SPC_GetWeeklyHoldOrders]    Script Date: 09/30/2014 15:20:17 ******/
...
--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**
/****** Object:  StoredProcedure [dbo].[SPC_GetWeeklyJacketOrders]    Script Date: 09/30/2014 16:12:36 ******/
...
GO
--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**
/****** Object:  StoredProcedure [dbo].[SPC_GetWeeklyLessFiveItemOrders]    Script Date: 09/30/2014 16:14:12 ******/
...
/****** Object:  StoredProcedure [dbo].[SPC_GetWeeklyReservationOrders]    Script Date: 09/30/2014 16:16:02 ******/
...
--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**
/****** Object:  StoredProcedure [dbo].[SPC_GetWeeklySampleOrders]    Script Date: 09/30/2014 16:18:28 ******/
...
ALTER TABLE [dbo].[Invoice] 
ADD [IsBillTo] [bit] NULL
GO
--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**
UPDATE [dbo].[Invoice] SET [IsBillTo] = 0
GO

UPDATE [dbo].[Invoice] SET [BillTo] = 22
GO
--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**
/****** Object:  StoredProcedure [dbo].[SPC_GetOrderClients]    Script Date: 10/06/2014 14:03:49 ******/
...
--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**
/****** Object:  View [dbo].[ReturnOrdersClients]    Script Date: 10/06/2014 14:01:08 ******/
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[ReturnOrdersClients]'))
DROP VIEW [dbo].[ReturnOrdersClients]
GO
...
CREATE VIEW [dbo].[ReturnOrdersClients]
AS
SELECT  0 AS ID
	  ,'' AS Name
...
/****** Object:  View [dbo].[ReturnOrdersShipmentAddressView]    Script Date: 10/09/2014 10:37:46 ******/
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[ReturnOrdersShipmentAddressView]'))
DROP VIEW [dbo].[ReturnOrdersShipmentAddressView]
GO
...
CREATE VIEW [dbo].[ReturnOrdersShipmentAddressView]
AS
	SELECT DISTINCT  dca.[ID] AS ID
		   ,dca.[CompanyName] AS Name  	
	FROM [dbo].[DistributorClientAddress] dca
		 JOIN [dbo].[Order] o
			ON dca.[ID] = o.[DespatchToExistingClient]
...
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Bank_Creator]') AND parent_object_id = OBJECT_ID(N'[dbo].[Bank]'))
ALTER TABLE [dbo].[Bank] DROP CONSTRAINT [FK_Bank_Creator]
GO

IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Bank_Modifier]') AND parent_object_id = OBJECT_ID(N'[dbo].[Bank]'))
ALTER TABLE [dbo].[Bank] DROP CONSTRAINT [FK_Bank_Modifier]
GO

/****** Object:  Table [dbo].[Bank]    Script Date: 10/03/2014 11:55:43 ******/
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'Bank', @level2type=N'COLUMN',@level2name=N'ID'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The name of the Bank' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'Bank', @level2type=N'COLUMN',@level2name=N'Name'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The name of the branch' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'Bank', @level2type=N'COLUMN',@level2name=N'Branch'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The address of the branch' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'Bank', @level2type=N'COLUMN',@level2name=N'Address'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The city of the branch' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'Bank', @level2type=N'COLUMN',@level2name=N'City'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The state of the branch' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'Bank', @level2type=N'COLUMN',@level2name=N'State'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The postalcode of the branch' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'Bank', @level2type=N'COLUMN',@level2name=N'Postcode'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The country of the branch' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'Bank', @level2type=N'COLUMN',@level2name=N'Country'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Bank AccountNo. of the Company' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'Bank', @level2type=N'COLUMN',@level2name=N'AccountNo'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Bank SwiftCode of the Company' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'Bank', @level2type=N'COLUMN',@level2name=N'SwiftCode'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Creator of the Bank' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'Bank', @level2type=N'COLUMN',@level2name=N'Creator'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Created Date of the Bank' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'Bank', @level2type=N'COLUMN',@level2name=N'CreatedDate'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Modifier of the Bank' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'Bank', @level2type=N'COLUMN',@level2name=N'Modifier'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Modified Date of the Bank' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'Bank', @level2type=N'COLUMN',@level2name=N'ModifiedDate'
GO
...
ALTER TABLE [dbo].[Bank]  WITH CHECK ADD  CONSTRAINT [FK_Bank_Creator] FOREIGN KEY([Creator])
REFERENCES [dbo].[User] ([ID])
GO

ALTER TABLE [dbo].[Bank] CHECK CONSTRAINT [FK_Bank_Creator]
GO

ALTER TABLE [dbo].[Bank]  WITH CHECK ADD  CONSTRAINT [FK_Bank_Modifier] FOREIGN KEY([Modifier])
REFERENCES [dbo].[User] ([ID])
GO

ALTER TABLE [dbo].[Bank] CHECK CONSTRAINT [FK_Bank_Modifier]
GO

--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**
INSERT INTO [Indico].[dbo].[Bank]
           ([Name], [Branch], [Number], [Address], [City], [State], [Postcode], [Country] , [AccountNo], [SwiftCode], [Creator], [CreatedDate], [Modifier], [ModifiedDate])
     VALUES
           ...
           ,''
           ,''
           ,(SELECT ID FROM [dbo].[Country] WHERE [ShortName] = 'Sri Lanka')
           ,'19508120-01'
           ,''
           ,1
           ,GETDATE()
...
UPDATE [dbo].[Invoice] SET [Bank] = 1 
GO

ALTER TABLE [dbo].[Invoice]
ALTER COLUMN [Bank] [int] NOT NULL
GO
...
DECLARE @RetVal int
	...
	BEGIN TRY
		...
		WHERE (od.[Status] IS NULL 
			...
			AND od.[ID] != 13536
			AND (od.[SheduledDate] BETWEEN cast(DATEADD(wk, DATEDIFF(wk, 0, '10-10-2014'), 0) AS DATE) 
			AND DATEADD(day, 2, CONVERT (date, '10-10-2014')))			 
		...
		WHILE EXISTS(SELECT * FROM @TempOrderDetail )
			BEGIN	
				...
				IF ((SELECT COUNT(ID) FROM @TempOrderDetailQty)> 0)
					BEGIN					
						SET @WeeklyProductionCapacityID = (SELECT ID FROM [dbo].WeeklyProductionCapacity WHERE WeekendDate = '10-10-2014')
...
--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**
/****** Object:  StoredProcedure [dbo].[SPC_GetInvoiceOrderDetails]    Script Date: 10/13/2014 14:28:55 ******/
...
--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**--**-**-**
UPDATE [dbo].[Invoice] SET [WeeklyProductionCapacity] = 93 WHERE [ID] = 40
GO
...
INSERT INTO [Indico].[dbo].[Page] ([Name], [Title], [Heading]) VALUES ('/ViewBanks.aspx', 'Banks', 'Banks')


INSERT INTO [Indico].[dbo].[MenuItem] ([Page], [Name], [Description], [IsActive], [Parent], [Position], [IsVisible])
     VALUES
           (SCOPE_IDENTITY(), 'Banks', 'Banks', 1, @Parent, @Position, 1)
...
/****** Object:  Table [dbo].[DeliveryOption]    Script Date: 10/15/2014 09:59:49 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DeliveryOption]') AND type in (N'U'))
DROP TABLE [dbo].[DeliveryOption]
GO
...
CREATE TABLE [dbo].[DeliveryOption](
 ...
 CONSTRAINT [PK_DeliveryOption] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON, FILLFACTOR = 90) ON [PRIMARY]
) ON [PRIMARY]
...
ADD [DeliveryOption] [int] NULL
GO

ALTER TABLE [dbo].[Order] WITH CHECK ADD CONSTRAINT [FK_Order_DeliveryOption] FOREIGN KEY([DeliveryOption])
REFERENCES [dbo].[DeliveryOption] ([ID])
GO

ALTER TABLE [dbo].[Order] CHECK CONSTRAINT [FK_Order_DeliveryOption]
GO

INSERT INTO [Indico].[dbo].[DeliveryOption] ([Name], [Description]) VALUES('Road Freight', 'Road Freight')
GO


INSERT INTO [Indico].[dbo].[DeliveryOption] ([Name], [Description]) VALUES('Airbag', 'Airbag')
GO
...
/****** Object:  View [dbo].[ReturnInvoiceDetails]    Script Date: 10/02/2014 10:46:50 ******/
SET ANSI_NULLS ON
GO
