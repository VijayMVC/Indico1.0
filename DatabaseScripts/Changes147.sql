ALTER TABLE dbo.[FabricCode] ADD [IsActive] bit NOT NULL CONSTRAINT [DF_FabricCode_IsActive] DEFAULT(1)
GO

ALTER TABLE dbo.[FabricCode] ADD [IsPure] bit NOT NULL CONSTRAINT [DF_FabricCode_IsPure] DEFAULT(0)
GO

/****** Object:  View [dbo].[FabricCodeDetailsView]    Script Date: 8/12/2015 4:43:33 PM ******/
DROP VIEW [dbo].[FabricCodeDetailsView]
GO

/****** Object:  View [dbo].[FabricCodeDetailsView]    Script Date: 8/12/2015 4:37:01 PM ******/
SET ANSI_NULLS ON
GO
